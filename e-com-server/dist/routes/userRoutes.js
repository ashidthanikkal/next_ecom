 ...
 */
router.get("/sellers", authMiddleware_1.default, userController_1.getSellers);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.put("/sellers/:id/approve", authMiddleware_1.default, userController_1.approveSeller);
/**
 * @swagger
 ...
 *         description: Server error
 */
router.put("/sellers/:id/disapprove", authMiddleware_1.default, userController_1.disapproveSeller);
